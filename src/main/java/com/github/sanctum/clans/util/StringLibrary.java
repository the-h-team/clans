...
public class StringLibrary {
	...
	public String alreadyMin(String instert1, String insert2) {
		return MessageFormat.format(ClansAPI.getDataInstance().getMessageResponse("already-min"), instert1, insert2);
	}

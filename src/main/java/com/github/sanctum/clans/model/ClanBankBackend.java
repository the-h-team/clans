 ...
 * @since 1.3.3
 */
public interface ClanBankBackend {
    /**
     ...
     */
    CompletableFuture<List<ClanBankLog.Transaction>> readTransactions(@NotNull Clan clan);
     ...
     */
    CompletableFuture<Void> updateTransactionLog(@NotNull Clan clan, @NotNull ClanBankLog log);
     ...
     */
    CompletableFuture<Void> addTransaction(@NotNull Clan clan, @NotNull ClanBankLog.Transaction transaction);
}

...
import com.github.sanctum.clans.model.addon.dynmap.DynmapClanMarkerSet;
import com.github.sanctum.clans.model.addon.dynmap.DynmapCommand;
...
public class DynmapAddon extends Clan.Addon {
	...
	public void onEnable() {
		...
		ClanVentBus.MEDIUM_PRIORITY.subscribeTo(CommandInformationAdaptEvent.class, "clans;dynmap-info_adapt", (e, subscription) -> {
			Clan.Addon cycle = ClanAddonRegistry.getInstance().get("Dynmap");

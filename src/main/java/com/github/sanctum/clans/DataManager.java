...
import com.github.sanctum.clans.util.FancyLogoAppendage;
...
public class DataManager {
	...
	public File getClanFolder() {
		final File dir = ClansAPI.getInstance().getPlugin().getDataFolder();
		File d = new File(dir.getParentFile().getPath(), "Clans/" + "Clans" + "/");
		if (!d.exists()) {
			d.mkdirs();
		}
		return d;
